...
exports.displayLearnerDashboard = void 0;
...
function displayLearnerDashboard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const queryAllCourse = `SELECT * FROM course_details`;
        const allCoursesFromDatabase = yield new Promise((resolve, reject) => {
            db.all(queryAllCourse, (err, allCoursesFromDatabase) => {
                if (err) {
                    reject(err);
                }
                else {
...
exports.displayLearnerDashboard = displayLearnerDashboard;
